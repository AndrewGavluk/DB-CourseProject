...
create procedure make_deal_part (in id_1 int, in id_2 int)/* q1 > q2*/
Begin
	DECLARE acc1 int;
	DECLARE acc2 int;
	...
	call ins_deal(acc1, acc2, prod, q2, price, T);
	update tab_order1 set order_quanity_in_trade = q3 where order_id = id_1;
